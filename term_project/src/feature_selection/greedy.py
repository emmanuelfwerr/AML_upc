...
class GreedyFeatureSelection: 
    '''
    A simple and custom class for greedy feature selection. You will 
    need to modify it quite a bit to make it suitable for your dataset.
    '''
    def evaluate_score(self, X, y):
        ...
        # BEWARE: you can choose any model that suits your data
    ...
    def _feature_selection(self, X, y):
        ...
        # infinite loop
        while True:
            # initialize best feature and score of this loop this_feature = None
            best_score = 0
